...
const App: FunctionComponent<{
  authedUserPromise: Promise<NonNullable<AuthedUserResponse["authedUser"]>>;
}> = ({ authedUserPromise }) => {
  ...
  return (
    <div className="min-h-screen bg-white px-4 py-10 text-zinc-950 antialiased dark:bg-zinc-950 dark:text-white">
      <header className="mx-auto mb-6 flex w-full max-w-5xl items-center gap-3 px-6 sm:px-10">
        <img
          src={authedUser.photo}
          alt={authedUser.name}
          className="size-10 rounded-full border border-zinc-950/10 object-cover dark:border-white/10"
        />
